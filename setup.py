...
VERSION_PATH = os.path.join(os.path.dirname(__file__), "aqc_research", "VERSION.txt")
...
setuptools.setup(
    ...
    url="https://github.com/qiskit-community/aqc-research",
    author="AQC Research Development Team",
    ...
    keywords="qiskit approximate ansatz target time-evolution Trotter",
    packages=setuptools.find_packages(include=["aqc_research", "aqc_research.*"]),
